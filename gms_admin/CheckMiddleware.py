...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self,request,view_func,view_args,view_kwargs):
        ...
        if user.is_authenticated:
            ...
            if request.path == reverse("show_login") or request.path == reverse("do_login") or request.path == reverse("send_otp") or request.path == reverse("otp_view") or modulename == "django.contrib.auth.views":
                pass
            else:
                return HttpResponseRedirect(reverse("show_login"))